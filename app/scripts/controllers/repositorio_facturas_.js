  ...
  function revision_factura(data) {
    repositorioFacturas.Estado_Factura().add(data).$promise.then(function(data) {
      if (data.numeroComprobantes==0) {
        $mdDialog.show( {
          controller: informativo_Ctrl, templateUrl: 'views/app/finanzas/contable/repositorio_facturas/subir_facturas/modal_informativo.html', 
        ...
        $mdDialog.show( {
          controller: modal_Ctrl, templateUrl: 'views/app/finanzas/contable/repositorio_facturas/subir_facturas/modal.html', 
          parent: angular.element(document.body), 
          clickOutsideToClose: false, 
