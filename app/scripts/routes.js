...
// --------------------------------------------vistas generadas rutas ------------------------------------------------
  app.config(function ($routeSegmentProvider, $routeProvider,$locationProvider) {
    ...
    $routeSegmentProvider.when('/Salir',    'salir')        
      .segment('salir', {
    ...
    $routeSegmentProvider.when('/Colaboradores/:ruc',    'acceso-colaboradores')
    ...
    $routeSegmentProvider.when('/Seleccionar_Sucursal',    'seleccionar_sucursal')
    ...
    // activar cuenta
    $routeSegmentProvider.when('/activarcuenta/:codigo',    'activar')        
      .segment('activar', {
    ...
    $routeSegmentProvider.when('/Actualizar_Datos',    'actualizar_datos')
    ...
    $routeSegmentProvider.when('/Actualizar_Datos_Sucursal',    'actualizar_datos_sucursal')
    ...
    .segment('nb', {
        ...
        .within()
          .segment('empresa', {
            ...
            .up()
          .segment('personal', {
            templateUrl: 'views/dashboard/perfilPersonal.html',
            controller: 'perfilPersonalCtrl'
          })
          .segment('sucursal', {
