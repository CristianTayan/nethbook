    ...
    .service('repositorioFacturas', function ($resource, urlService, $localStorage) {
      ...
      this.Get_Gastos = function() {
        ...
        this.Extraer_Clave_Acceso = function($fileContent) {
          ...
          var nombre_empresa = _.keys(xml_final.comprobante);
          console.log('list : '+nombre_empresa);

          var xyz = _.values(xml_final);
          console.log('values : '+xyz);

            var data = '1810201704179125123700120050140006813720068137218';
