...
///////////////////////////////////////// IMAGENES DE PERFIL /////////////////////////////////////////
    ...
    Route::post('Add_Img_PerfilEmpresa', 'Perfil@Add_Img_PerfilEmpresa');
    //  SELECCIONAR IMAGEN DE PERFIL 
    Route::post('Set_Img_Perfil', 'Perfil@Set_Img_Perfil');
    Route::post('Set_Img_PerfilUsuario', 'Perfil@Set_Img_PerfilUsuario');
    Route::post('Set_Img_PerfilEmpresa', 'Perfil@Set_Img_PerfilEmpresa');
    ...
    Route::post('Get_Img_PerfilEmpresa', 'Perfil@Get_Img_PerfilEmpresa');
    ...
    Route::post('Delete_Img_PerfilEmpresa', 'Perfil@Delete_Img_PerfilEmpresa');
///////////////////////////////////////// IMAGENES DE LOGO /////////////////////////////////////////
...
///////////////////////////////////////// IMAGENES DE PORTADA /////////////////////////////////////////
    ...
    Route::post('Add_Img_PortadaEmpresa', 'Portada@add_img_portadaEmpresa');
    // SELECCIONAR IMAGEN DE PORTADA
    Route::post('Set_Img_Portada', 'Portada@Set_Img_Portada');
    Route::post('Set_Img_PortadaUsuario', 'Portada@Set_Img_PortadaUsuario');
    Route::post('Set_Img_PortadaEmpresa', 'Portada@Set_Img_PortadaEmpresa');
    ...
    Route::post('Load_Imgs_PortadaEmpresa', 'Portada@Load_Imgs_PortadaEmpresa');
    ...
    Route::post('Get_Img_PortadaEmpresa', 'Portada@Get_Img_PortadaEmpresa');
